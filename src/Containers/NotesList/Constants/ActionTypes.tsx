enum ActionTypes {
    ...
    DELETE_NOTE_IN_PROGRESS = 'NOTES_LIST/DELETE_NOTE_IN_PROGRESS',
    ...
    LOAD_NOTES = 'NOTES_LIST/LOAD_NOTES',
    SAVE_NOTES = 'NOTES_LIST/SAVE_NOTES',
    SET_NOTES = 'NOTES_LIST/SET_NOTES',
